...
def get_temp_email_and_otp():
    with sync_playwright() as p:
        ...
        page.fill("//input[@aria-label='Enter your password']", "Samyak@1996")
        page.click("//span[text()='Next']")
        time.sleep(6)
        ...
        page2.locator("//button[.//*[name()='svg' and contains(@class,'lucide-chevron-right')]]").click()
        print("Forward the month")
        time.sleep(5)
        browser.close()
