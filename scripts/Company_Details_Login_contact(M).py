...
def get_temp_email_and_otp_mobile():
    with sync_playwright() as p:
        ...
        page2.goto("https://10times.com/company/oxford-management-centre-united-states-of-america", wait_until="networkidle")
        time.sleep(5)

        # MOBILE menu
        page2.locator("(//span[@id='contacts'])[1]").click()
        page2.locator("//span[contains(text(), 'Continue with Google')]").click()
        print("User contact the company page")
        time.sleep(5)
