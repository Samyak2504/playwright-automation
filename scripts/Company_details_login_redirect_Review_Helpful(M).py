...
def get_temp_email_and_otp_mobile():
    with sync_playwright() as p:
        ...
        page2.goto("https://10times.com/company/the-royal-institution-of-chartered-surveyors", wait_until="networkidle")
        time.sleep(5)
        ...
        page2.locator("//button[@id='review-link']").click()
        print("User Redirect to the Review section")

        page2.locator("(//span[normalize-space()='Helpful'])[1]").click()
        print("User intent on the Helpful button")
