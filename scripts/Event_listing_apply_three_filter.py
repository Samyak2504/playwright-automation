...
def get_temp_email_and_otp():
    with sync_playwright() as p:
        ...
        try:
            ...
            tradeshows.click(timeout=5000)
            print("  Clicked on 'Tradeshows' filter")
        except TimeoutError:
            print("   Couldn't find 'Tradeshows' link. Check locator or page load.")
        ...
        try:
            ...
            london_filter.click(timeout=5000)
            print("  Clicked on 'London' filter")
        except TimeoutError:
            print("   Couldn't click 'London' filter.")
        ...
        try:
            edu_filter.click(timeout=5000, force=True)
